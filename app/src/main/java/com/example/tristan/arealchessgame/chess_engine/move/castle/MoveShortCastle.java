...
public class MoveShortCastle extends MoveCastle {

    public MoveShortCastle(Board board, King king, Rook rook, int xDestinationKing, int yDestinationKing, int xDestinationRook, int yDestinationRook) {
